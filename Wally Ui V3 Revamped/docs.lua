...
_G.TertiaryColor = Color3.fromRGB(0,0,0)
_G.ArrowColor = Color3.fromRGB(0,0,0)
_G.MainTextColor = Color3.fromRGB(0,0,0)
_G.PointerColor = Color3.fromRGB(0,0,0)
_G.ButtonTextColor = Color3.fromRGB(0,0,0)
_G.SliderColor = Color3.fromRGB(0,0,0)
_G.ButtonColor = Color3.fromRGB(0,0,0)
_G.ToggleColor = Color3.fromRGB(0,0,0)
_G.DraggerCircleColor = Color3.fromRGB(0,0,0)
_G.BindColor = Color3.fromRGB(0,0,0)
]]

local library = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Majora144/Ui-libs-back-ups/main/Wally%20Ui%20V3%20Revamped/main.lua')))()
