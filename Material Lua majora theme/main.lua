...
local Themes = {
	...
	Majora = {
		...
		Minimise = Color3.fromRGB(77,77,77),
		MinimiseAccent = Color3.fromRGB(255,60,80),
		Maximise = Color3.fromRGB(56, 57, 187),
		Maximise = Color3.fromRGB(56, 57, 187),
		NavBar = Color3.fromRGB(27,27,27),
		NavBarAccent = Color3.fromRGB(30,30,30),
		Navbar = Color3.fromRGB(27,27,27),
		TitleBar = Color3.fromRGB(27,27,27),
		TitleBarAccent = Color3.fromRGB(30,30,30),
		Overlay = Color3.fromRGB(56, 57, 187),
		Banner = Color3.fromRGB(27,27,27),
		BannerAccent = Color3.fromRGB(66,67,197),
		Button = Color3.fromRGB(46,47,177),
		ButtonAccent = Color3.fromRGB(56,58,187),
		ChipSet = Color3.fromRGB(46,47,177),
		ChipSetAccent = Color3.fromRGB(56,58,187),
		DataTable = Color3.fromRGB(56,58,187),
		DataTableAccent = Color3.fromRGB(46,47,177),
		Slider = Color3.fromRGB(56,58,187),
		SliderAccent = Color3.fromRGB(46,47,177),
		Toggle = Color3.fromRGB(56,58,187),
		ToggleAccent = Color3.fromRGB(46,47,177),
		Dropdown = Color3.fromRGB(56,58,187),
		DropdownAccent = Color3.fromRGB(46,47,177)
	}
}
